        ...
        <div class="flex items-center gap-3">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                >
                    ...
                    <span class="hidden sm:block text-sm font-medium text-stone-700 group-hover:text-stone-900 transition-colors">Admin</span>
                ...
                >
                    ...
                    <a href="#" class="flex items-center gap-2.5 px-4 py-2 text-sm text-red-500 hover:bg-red-50 transition-colors">
